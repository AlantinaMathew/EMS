...
<body>
    ...
    <div class="out">
        <div class="c" style="background:white;justify-content:center;">
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-25">
                        <label for="Location">Vehicle Number</label>
                    </div>
                    <div class="col-75">{{$tr->vehicle_num}}</div>
                    </div>
                    <div class="row">
                        <div class="col-25">
  ...
  text-decoration: none;
  display: inline-block;
  font-size: 16px;">Declined</button>
                                @elseif($tr->status==1)
                                <button style="background-color: #4CAF50; /* Green */
  border: none;
  color: white;
  ...
  text-decoration: none;
  display: inline-block;
  font-size: 16px;">Accepted</button>
                                @else
                                <button style="background-color: #4CAF50; /* Green */
  border: none;
  color: white;
