...
<div class="outer">
  ...
  <a href="{{ route('view_loc_rep', $tr->id) }}"><button class="btn"><i class="fa fa-close"></i>View Location</button></a>
  @endif </td>
                <td>
                    {{$tr->phone}}
                </td>
  ...
  <td>
  <a href="{{ route('decline_rep', $tr->id) }}"><button style=" background-color: DodgerBlue;
  border: none;
  color: white;
  padding: 12px 16px;
  font-size: 16px;
