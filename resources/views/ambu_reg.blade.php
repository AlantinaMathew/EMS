...
<x-guest-layout style="margin-top:-10p;">
    ...
    <x-slot name="logo">
        ...
        <form method="POST" action="/reg_ambu" style="margin-top:0;"onSubmit="return myfunction7()">
            @csrf
            ...
            <div>
                <x-label for="vehicleno" :value="__('Vehicle No')" />

                <x-input id="vehclno" class="block mt-1 w-full" type="text" name="vehicleno" :value="old('vehicleno')" required autofocus />
                <span id="a3"></span>
            </div>
            <div>
                <x-label for="licenseno" :value="__('License No')" />

                <x-input id="licenseno" class="block mt-1 w-full" type="text" name="licenseno" :value="old('licenseno')" required autofocus />
                <span id="a4"></span>
            </div>
            <!-- PHONE -->
            <div class="mt-4">
            ...
            <div class="flex items-center justify-end mt-4">
                <a class="underline text-sm text-gray-600 hover:text-gray-900" href="/log_ambu">
...
let lic=document.getElementById('licenseno').value;
let vhcl=document.getElementById('vehclno').value;
...
if (regex.test(em)) {
    ...
    //alert("k1");
    span["a1"].innerText = "Enter a valid Email";
...
if (mobreg.test(mob)) {
    ...
    //alert("k1");
    span["a2"].innerText = "Only 10 Digit Numbers Allowed";
